...
time java -cp lib/commons-io-2.4.jar:lib/vicino-zz.jar:lib/secondstring-20100303.jar:./build/sample_classes edu.tsinghua.dbgroup.sample.VicinoTester 2 performance/author.data > vicino_out_zz
